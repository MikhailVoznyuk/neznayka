                                  ...
                                  ifCorrectHandler={() => {
                                    ...
                                    setTimeout(() => {
                                      ...
                                      if (stage == count - 2) {
                                        ...
                                        if (userScore == 100) {
                                          quizResultText = "Так держать! Ты не допустил ни одной ошибки! Наши уроки и учебные материалы помогут тебе поддерживать и повышать свой уровень знаний!"
                                        } else if (50 <= userScore && userScore < 100) {
                                          quizResultText = "Ты успешно прошел викторину! Были допущены одна или несколько ошибок, поэтому самое время ознакомиться с нашими уроками по тем категориям, где ты ошибся!"
